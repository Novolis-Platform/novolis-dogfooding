...
| `MeshBench` | [novolis-workspaces/samples/MeshBench](../novolis-workspaces/samples/MeshBench) | Workspaces + Timeline + Snapshots + Rendering + Audio (Avalonia mini CAD; run from workspaces repo until GPR packages land) |
