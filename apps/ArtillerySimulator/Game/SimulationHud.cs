...
internal static class SimulationHud
{
        ...
        float fps)
    {
        ...
        const int w = 500;
        const int lineH = 17;
        var lines = shot.Phase == BallisticTrajectoryPhase.InFlight ? 19 : 18;
        ...
        {
            var reason = impact.Reason == ProjectileTerrainImpactReason.BeyondRange ? "  Range limit (map edge)" : "";
            ctx.HudText(
        ...
        else if (shot.Phase != BallisticTrajectoryPhase.InFlight)
        {
